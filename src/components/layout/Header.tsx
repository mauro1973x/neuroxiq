          ...
          <nav className="container py-4 flex flex-col gap-2">
            ...
            {user ? (
              <>
                ...
                <button
                  className="px-4 py-2 text-sm font-medium text-destructive text-left hover:bg-muted rounded-lg transition-colors"
                  onClick={() => {
                    handleSignOut();
                    setIsMenuOpen(false);
                  }}
              ...
              <>
                ...
                <Button variant="hero" onClick={() => { navigate('/cadastro'); setIsMenuOpen(false); }}>
                  Começar Grátis
                </Button>
              </>
            )}
