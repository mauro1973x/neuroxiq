...
export const emotionalResultBands: EmotionalResultBand[] = [
  {
    ...
    freeDescription: "Seu perfil indica que há oportunidades significativas para desenvolver suas habilidades emocionais. A boa notícia é que a inteligência emocional pode ser aprendida e aprimorada com prática.",
  ...
  },
  {
    ...
    freeDescription: "Você demonstra consciência emocional básica e está no caminho para desenvolver habilidades mais sofisticadas. Continue investindo no autoconhecimento.",
  ...
  },
  {
    ...
    freeDescription: "Você possui uma base sólida de inteligência emocional, com capacidade de reconhecer e gerenciar emoções na maioria das situações.",
  ...
  },
  {
    ...
    freeDescription: "Você demonstra habilidades emocionais acima da média, com boa capacidade de autogestão e relacionamento interpessoal.",
  ...
  },
  {
    ...
    freeDescription: "Você possui inteligência emocional excepcional, com domínio avançado de todas as competências emocionais avaliadas.",
