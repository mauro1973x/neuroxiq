...
export const emotionalResultBands: EmotionalResultBand[] = [
  {
    ...
    freeDescription: "Suas emoções guardam chaves que você ainda não aprendeu a usar. Há um potencial transformador escondido no seu perfil — a análise completa revela como acessá-lo.",
  ...
  },
  {
    ...
    freeDescription: "Algo está despertando no seu perfil emocional. Você demonstra sinais de uma consciência que poucos desenvolvem — descubra até onde ela pode te levar.",
  ...
  },
  {
    ...
    freeDescription: "Seu equilíbrio emocional esconde camadas mais profundas do que aparenta. Há padrões no seu perfil que podem redefinir seus relacionamentos e sua carreira.",
  ...
  },
  {
    ...
    freeDescription: "Poucos possuem o que você demonstrou. Suas habilidades emocionais revelam um perfil raro — e há dimensões ainda inexploradas que a análise completa desvenda.",
  ...
  },
  {
    ...
    freeDescription: "Resultado extraordinário. Você pertence a um grupo seleto com maestria emocional rara. O que descobrimos sobre seu perfil pode surpreender até você mesmo.",
